...
namespace IntelliFin.AdminService.Migrations
{
    ...
    [Migration("20251102090000_AddIncidentResponse")]
    partial class AddIncidentResponse
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IntelliFin.AdminService.Models.RecertificationTask", b =>
                ...
                modelBuilder.Entity("IntelliFin.AdminService.Models.IncidentPlaybook", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("AutomationProcessKey")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");
                    ...
                    b.Property<string>("LinkedRunbookUrl")
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)");
                    ...
                    b.ToTable("IncidentPlaybooks");
                });

                modelBuilder.Entity("IntelliFin.AdminService.Models.IncidentPlaybookRun", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<bool>("AutomationInvoked")
                        .HasColumnType("bit");

                    b.Property<string>("AutomationOutcome")
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)");
                    ...
                    b.Property<int>("IncidentPlaybookId")
                        .HasColumnType("int");
                    ...
                    b.Property<string>("PagerDutyIncidentId")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");
                    ...
                    b.Property<double?>("ResolutionMinutes")
                        .HasColumnType("float");
                    ...
                    b.HasIndex("IncidentPlaybookId")
                        .HasDatabaseName("IX_IncidentPlaybookRuns_IncidentPlaybookId");

                    b.HasIndex("RunId")
                        .IsUnique()
                        .HasDatabaseName("IX_IncidentPlaybookRuns_RunId");

                    b.ToTable("IncidentPlaybookRuns");
                });

                modelBuilder.Entity("IntelliFin.AdminService.Models.OperationalIncident", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<DateTime?>("PostmortemCompletedAt")
                        .HasColumnType("datetime2");

                    b.Property<DateTime?>("PostmortemDueAt")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<string>("SlackThreadUrl")
                        .HasMaxLength(300)
                    ...
                    b.HasIndex("IncidentPlaybookId")
                        .HasDatabaseName("IX_OperationalIncidents_IncidentPlaybookId");
                ...
                modelBuilder.Entity("IntelliFin.AdminService.Models.AlertSilenceAudit", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("AlertmanagerUrl")
                        .IsRequired()
                        .HasMaxLength(300)
                        .HasColumnType("nvarchar(300)");
                    ...
                    b.HasIndex("SilenceId")
                        .HasDatabaseName("IX_AlertSilenceAudits_SilenceId");

                    b.ToTable("AlertSilenceAudits");
                });

                modelBuilder.Entity("IntelliFin.AdminService.Models.IncidentPlaybookRun", b =>
                {
                    b.HasOne("IntelliFin.AdminService.Models.IncidentPlaybook", "Playbook")
                        .WithMany("Runs")
                        .HasForeignKey("IncidentPlaybookId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
