...
public class LoanApplication
{
    ...
    public string LoanNumber { get; set; } = string.Empty; // Generated by LoanVersioningService (Story 1.2)
    ...
    // Pause tracking for KYC revocation or compliance issues
...
{
    public Guid Id { get; set; }
    public string? LoanNumber { get; set; } // Optional, backward compatible field added for versioning
...
public enum LoanApplicationStatus
{
    ...
    Withdrawn = 7,
    Expired = 8,
    Paused = 9 // Workflow paused due to KYC revocation or compliance issues
}
